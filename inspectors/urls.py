...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='inspectors/password_reset_form.html',html_email_template_name='inspectors/password_reset_email.html',subject_template_name='inspectors/password_reset_subject.txt'), name='password_reset'),
